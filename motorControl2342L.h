...
int _iExpectedCentiRevolutions; // At each start of the motor, this value stores the number of centi-revolutions asked to the motor (computed from iDuration and irpm)
